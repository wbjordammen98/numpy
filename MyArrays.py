...
print(np.zeros(5))  # create an array of 5 0's
...
array2 = np.full((3,5),13) # create an array of 3 rows and 5 columns of the number 13
...
array4 = np.arange(1,100001).reshape(100,000)
